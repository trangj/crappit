...
export class AddNotifications1658622217133 implements MigrationInterface {
    name = 'AddNotifications1658622217133'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notification_setting" ("user_id" integer NOT NULL, "notification_type_id" integer NOT NULL, "value" boolean NOT NULL, CONSTRAINT "PK_fdd111f7ff070793544114052db" PRIMARY KEY ("user_id", "notification_type_id"))`);
