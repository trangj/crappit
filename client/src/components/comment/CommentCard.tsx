	...
	return (
		<Card id="comments" className="p-3">
			<div className="mx-6">
				...
				<SortComment post={post} topic={topic} sortParam={sortParam} setSortParam={setSortParam} />
				<Divider className="mb-8 mt-1" />
			</div>
			<CommentList isCommentsLoading={isCommentsLoading} comments={comments!} topic={topic} />
		</Card>
	);
};
