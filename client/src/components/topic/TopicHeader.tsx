	...
	return (
		<div className="mt-12 bg-white dark:bg-gray-850">
			...
			<div className="container mx-auto max-w-5xl px-5">
				<div className="flex pb-3 -mt-3">
					<div className="h-20 w-20 flex rounded-full border-4 border-white" style={{ zIndex: 1 }}>
						{!topic.icon_image_name ? <Avatar /> : <Image alt="topic icon" src={topic.icon_image_name} width={80} height={80} className="rounded-full" />}
					</div>
					<div className="flex mt-5 pl-4 w-full justify-between" style={{ width: "calc(100% - 80px)" }}>
						<div className="inline-block gap-3 min-h-10 pr-4" style={{ maxWidth: "calc(100% - 96px)" }}>
