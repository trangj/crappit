...
import useDeleteModerator from 'src/hooks/topic-query/useDeleteModerator';
...
const DeleteModerator = ({ topic, user }: Props) => {
    ...
    return (
        <>
            <Button onClick={() => setOpen(true)} variant="filled" border="rounded-full" className="bg-red-500 dark:bg-red-500 ml-auto">
                Remove
            </Button>
            <Dialog
                as="div"
            ...
            >
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="bg-white dark:bg-gray-850 rounded border border-gray-200 dark:border-gray-700 max-w-sm mx-auto z-50 p-4">
                        ...
                        <Dialog.Description>
                            Are you sure you want to remove {user.username} as moderator? You can&apos;t undo this.
                        </Dialog.Description>
